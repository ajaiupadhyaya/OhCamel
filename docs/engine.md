...
[`docs/quant_notes.md`](quant_notes.md) — every formula cross-referenced to
...
![The dashboard, driven by the synthetic feed](media/dashboard.png)
...
([`docs/CHARTER.md`](CHARTER.md)) says the bars come from "Alpaca (IEX,
...
[`docs/quant_notes.md`](quant_notes.md) is the reference companion to this
