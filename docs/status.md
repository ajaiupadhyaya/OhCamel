...
- **315 hermetic tests** — no network, no credentials, nothing waiting on a
...
- **Coverage 82.5%** (3,803 / 4,612 instrumented points, measured 2026-09-12), with a 60% floor in CI that exists to make deleting
